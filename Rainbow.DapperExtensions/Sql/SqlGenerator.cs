...
namespace Rainbow.DapperExtensions.Sql
{
    ...
    public class SqlGeneratorImpl : ISqlGenerator
    {
        ...
        public virtual string Update(IClassMapper classMap, IPredicate predicate, IDictionary<string, object> parameters, bool ignoreAllKeyProperties)
        {
            ...
            var columns = ignoreAllKeyProperties
                ? classMap.SelectedProperties.Where(p => !(p.Ignored || p.IsReadOnly) && p.KeyType == KeyType.NotAKey)
                : classMap.SelectedProperties.Where(p => !(p.Ignored || p.IsReadOnly || p.KeyType == KeyType.Identity || p.KeyType == KeyType.Assigned));
            ...
            classMap.SelectedProperties = null; //clear
        ...
        {
            var columns = classMap.SelectedProperties
                .Where(p => !p.Ignored)
