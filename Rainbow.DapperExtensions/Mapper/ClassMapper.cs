...
namespace Rainbow.DapperExtensions.Mapper
{
    public interface IClassMapper
    {
        ...
        IList<IPropertyMap> SelectedProperties { get; set; }
    }
    ...
    public class ClassMapper<T> : IClassMapper<T> where T : class
    {
        ...
        /// <summary>
        /// A collection of properties that will be selected or updated to columns in the database table.
        /// </summary>
        private IList<IPropertyMap> _selectedProperties;
        public IList<IPropertyMap> SelectedProperties
        {
            get { return _selectedProperties ?? Properties; }
        ...
        protected virtual void AutoMap(Func<Type, PropertyInfo, bool> canMap)
        {
            ...
            foreach (var propertyInfo in type.GetProperties(BindingFlags.Public | BindingFlags.Instance))
            {
                ...
                if (!ReflectionHelper.IsSimpleType(propertyInfo.PropertyType))
                {
                    continue;
                }
